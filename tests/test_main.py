...
def test_gandi_parsing():
    ...
    assert (
        hits[1]['user_agent']
        == u'Mozilla/5.0 (Macintosh; Intel Mac OS X 10.13; rv:90.0) Gecko/20100101 Firefox/90.0'
    )
...
def test_incapsulaw3c_parsing():
    ...
    assert (
        hits[0]['user_agent']
        == u'Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko)'
        u' Chrome/58.0.3029.110 Safari/537.36'
    )
    ...
    assert (
        hits[1]['user_agent']
        == u'Mozilla/5.0 (Macintosh; Intel Mac OS X 10.10; rv:45.0) Gecko/20100101'
        u' Thunderbird/45.8.0 Lightning/4.7.8'
    )
